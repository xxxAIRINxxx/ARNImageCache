...
// ARNImageCache
#define COCOAPODS_POD_AVAILABLE_ARNImageCache
#define COCOAPODS_VERSION_MAJOR_ARNImageCache 0
#define COCOAPODS_VERSION_MINOR_ARNImageCache 1
#define COCOAPODS_VERSION_PATCH_ARNImageCache 0
